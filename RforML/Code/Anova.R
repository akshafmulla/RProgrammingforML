...
r = c(t(as.matrix(df1)))  #used transpose function to convert it into a vector
r
...
#creating the vector of groups corresponding to each element of r
...
# There is no significant difference in the group means\6s